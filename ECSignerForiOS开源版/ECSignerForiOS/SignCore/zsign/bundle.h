...
public:
	bool SignFolder(ZSignAsset *pSignAsset, const string &strFolder,const string &strBundleVersion ,const string &strBundleID, const string &strDisplayName, bool bForce, bool bWeakInject, bool bEnableCache);
