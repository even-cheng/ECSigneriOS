...
- (XPMArgumentPackage *)xpmargs_parseArgumentsWithSignatures:(id)signatures arguments:(NSArray *)arguments
{
    XPMArgumentParser * p = [[XPMArgumentParser alloc] initWithArguments:arguments signatures:signatures];
    return [p parse];
}
